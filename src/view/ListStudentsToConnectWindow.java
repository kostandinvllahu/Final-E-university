...
public class ListStudentsToConnectWindow extends Window {

	private static final long serialVersionUID = 8969121511313736097L;

	public ListStudentsToConnectWindow() {
		
		ArrayList<Student> list = DBHandler.db.getStudentsToConnect();
		
		if (list.size() == 0) {
			JOptionPane.showMessageDialog(null, "0 students to connect!");
