...
public class ListMinorSubjectsWindow extends Window {

	private static final long serialVersionUID = -8763889980015737796L;
	
	public ListMinorSubjectsWindow() {
		
		setTitle(Settings.SYSTEM_TITLE + " - Minor Subjects");
	
		String[] list = Arrays.copyOfRange(DBHandler.db.getMinorSubjects(), 1, DBHandler.db.getMinorSubjects().length);
